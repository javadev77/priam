...
public class ParticipantFileItemReader extends AbstractItemCountingItemStreamItemReader<Participant> implements
        ResourceAwareItemReaderItemStream<Participant>, InitializingBean {
    ...
    private LineMapper<Participant> lineMapper;
    ...
    public ParticipantFileItemReader() {
        setName(ClassUtils.getShortName(ParticipantFileItemReader.class));
    }
     ...
     */
    public void setLineMapper(LineMapper<Participant> lineMapper) {
    ...
    @Override
    protected Participant doRead() throws Exception {
        if (noInput) {
            return null;
        }
