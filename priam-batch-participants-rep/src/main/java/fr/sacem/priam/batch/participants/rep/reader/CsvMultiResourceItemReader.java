...
public class CsvMultiResourceItemReader<T> extends MultiResourceItemReader<T> {
    ...
    public static final String PREFIX_FILE_PARTICIPANTS_FRA ="FF_PRIAM_PARTICIPANTS_FRA_REP";
                    ...
                    if (fichiersCSV.length >= 1) {
                        if (fichiersCSV[0] != null) {
                            ...
                            if (fichiersCSVDansLeRepertoire.size() >= 1) {
                                ...
                                if(!file.getName().contains(PREFIX_FILE_PARTICIPANTS_FRA)) {
                                    ...
                                    JobParameter jobParameterTypeCMS = new JobParameter("FR");
                                    this.stepExecution.getExecutionContext().put("nomFichier", jobParameterNomDuFichier);
                                    this.stepExecution.getExecutionContext().put("typeCMS", jobParameterTypeCMS);
