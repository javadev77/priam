<style>
  ...
  .v-select .open-indicator {
    ...
    border-color: #4b77be transparent;
    border-style: solid;
  ...
  */
  ...
  .v-select li:last-child > a  {
    border-top-right-radius: 4px;
    border-top-left-radius: 4px;
  }

  .v-select li:first-child > a  {
      ...
      filteredOptions() {
        let options = this.mutableOptions.filter((option) => {
          if (typeof option === 'object' && option.hasOwnProperty(this.label)) {
            return option[this.label].toString().toLowerCase().indexOf(this.search.toString().toLowerCase()) > -1
          ...
          return option.toString().toLowerCase().indexOf(this.search.toString().toLowerCase()) > -1
        })
