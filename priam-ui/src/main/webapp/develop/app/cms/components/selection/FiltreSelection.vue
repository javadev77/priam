  ...
  export default {
    ...
    data() {
      ...
      return {
        showMipsa : false,
        utilisateursOptions : [],
        urlAutoCompleteIDE12 : process.env.CONTEXT_ROOT_PRIAM_CMS + 'app/rest/ligneProgramme/ide12',
        urlAutoCompleteTitreOeuvre : process.env.CONTEXT_ROOT_PRIAM_CMS + 'app/rest/ligneProgramme/titreOeuvre'
