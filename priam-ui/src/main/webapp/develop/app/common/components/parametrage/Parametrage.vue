  ...
  export default {
      ...
      data() {
          ...
          return {
            ...
            familleSelected : this.$store.getters.userFamille !== null && this.$store.getters.userFamille !== undefined ? this.$store.getters.userFamille : {'id' :'ALL', "value" : "Toutes"}
          }
      ...
      methods :  {
        ...
        enregistrer() {
          ...
          this.resource.enregistrerParametrage(parametrage)
            .then(response => {
              $this.$store.commit('SELECT_PAGE_SIZE', $this.userPageSize);
              $this.$store.commit('SELECT_FAMILLE', $this.familleSelected.id+","+$this.familleSelected.value);
              $this.$router.push("/");
          });
