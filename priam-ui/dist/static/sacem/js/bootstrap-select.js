    ...
    Selectpicker.prototype = {
        ...
        checkDisabled: function() {
            if (this.$element.is(':disabled')) {
                ...
                this.disableHandler = this.button.click(function(e) {
                    e.preventDefault();
                });
            } else {
                /* PALOITFIX : removed disable behaviour when attribute is removed */
                this.button.removeClass('disabled');
                if ( this.disableHandler ) {
                    this.button.off('click', '', this.disableHandler) ;
                }
            }
        },
