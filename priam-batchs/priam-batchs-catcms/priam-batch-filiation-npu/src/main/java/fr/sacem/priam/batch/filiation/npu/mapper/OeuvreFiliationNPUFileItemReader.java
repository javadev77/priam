...
public class OeuvreFiliationNPUFileItemReader extends AbstractItemCountingItemStreamItemReader<OeuvreFiliationNPU> implements
        ResourceAwareItemReaderItemStream<OeuvreFiliationNPU>, InitializingBean {

    private static final Log logger = LogFactory.getLog(OeuvreFiliationNPUFileItemReader.class);
    ...
    private LineMapper<OeuvreFiliationNPU> lineMapper;
    ...
    public OeuvreFiliationNPUFileItemReader() {
        setName(ClassUtils.getShortName(OeuvreFiliationNPUFileItemReader.class));
    }
     ...
     */
    public void setLineMapper(LineMapper<OeuvreFiliationNPU> lineMapper) {
    ...
    @Override
    protected OeuvreFiliationNPU doRead() throws Exception {
        if (noInput) {
            return null;
        }
