...
public class ConfigurationPriamProd {
    ...
    private String inputDirectory = String.valueOf(EnvConstants.CATCMS_FILIATION_NPU_INPUT);
    private String outputDirectory = String.valueOf(EnvConstants.CATCMS_FILIATION_NPU_ARCHIVES);
