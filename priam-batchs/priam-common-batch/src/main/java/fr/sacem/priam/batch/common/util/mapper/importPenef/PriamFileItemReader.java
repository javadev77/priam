 ...
 */
public class PriamFileItemReader extends AbstractItemCountingItemStreamItemReader<LigneProgramme> implements
        ResourceAwareItemReaderItemStream<LigneProgramme>, InitializingBean {
    ...
    private LineMapper<LigneProgramme> lineMapper;
    ...
    public PriamFileItemReader() {
        setName(ClassUtils.getShortName(PriamFileItemReader.class));
    }
     ...
     */
    public void setLineMapper(LineMapper<LigneProgramme> lineMapper) {
     ...
     */
    @Override
    protected LigneProgramme doRead() throws Exception {
        if (noInput) {
            return null;
        }
