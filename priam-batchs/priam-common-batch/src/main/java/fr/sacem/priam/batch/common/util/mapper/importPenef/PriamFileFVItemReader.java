 ...
 */
public class PriamFileFVItemReader extends AbstractItemCountingItemStreamItemReader<LigneProgrammeFV> implements
        ResourceAwareItemReaderItemStream<LigneProgrammeFV>, InitializingBean {
    ...
    private LineMapper<LigneProgrammeFV> lineMapper;
    ...
    public PriamFileFVItemReader() {
        setName(ClassUtils.getShortName(PriamFileFVItemReader.class));
    }
     ...
     */
    public void setLineMapper(LineMapper<LigneProgrammeFV> lineMapper) {
     ...
     */
    @Override
    protected LigneProgrammeFV doRead() throws Exception {
        if (noInput) {
            return null;
        }
