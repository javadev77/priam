 ...
 */
public class PriamFileADInfoItemReader extends AbstractItemCountingItemStreamItemReader<AyantDroitPers> implements
        ResourceAwareItemReaderItemStream<AyantDroitPers>, InitializingBean {
    ...
    private LineMapper<AyantDroitPers> lineMapper;
    ...
    public PriamFileADInfoItemReader() {
        setName(ClassUtils.getShortName(PriamFileADInfoItemReader.class));
    }
     ...
     */
    public void setLineMapper(LineMapper<AyantDroitPers> lineMapper) {
     ...
     */
    @Override
    protected AyantDroitPers doRead() throws Exception {
        if (noInput) {
            return null;
        }
