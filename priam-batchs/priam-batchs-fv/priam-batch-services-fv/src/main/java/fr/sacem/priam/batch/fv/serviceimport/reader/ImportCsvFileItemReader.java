...
import fr.sacem.priam.batch.common.util.mapper.importPenef.PriamFileItemReader;
...
public class ImportCsvFileItemReader extends AbstractItemCountingItemStreamItemReader<ExportCsvDto> implements
    ResourceAwareItemReaderItemStream<ExportCsvDto>, InitializingBean,  StepExecutionListener {

    private ImportProgrammeFVDao importProgrammeFVDao;
    private ImportProgrammeFV importProgrammeFV;

    private static final Log logger = LogFactory.getLog(PriamFileItemReader.class);
    ...
    private LineMapper<ExportCsvDto> lineMapper;
    ...
    @Autowired
    public ImportCsvFileItemReader(ImportProgrammeFVDao importProgrammeFVDao) {
        this.importProgrammeFVDao = importProgrammeFVDao;
        setName(ClassUtils.getShortName(ImportCsvFileItemReader.class));
    }
    ...
    public void beforeStep(final StepExecution stepExecution) {
        ...
        importProgrammeFV = importProgrammeFVDao.getFichierImporte(numProg);
        // Create springbatch input stream resource
        ByteArrayInputStream is = new ByteArrayInputStream(importProgrammeFV.getContent());
     ...
     */
    public void setLineMapper(LineMapper<ExportCsvDto> lineMapper) {
     ...
     */
    @Override
    protected ExportCsvDto doRead() throws Exception {
        if (noInput) {
            return null;
        }
        ...
        if (line == null) {
            ...
            try {
                ...
                PriamValidationException.ErrorType errorType = ex instanceof IncorrectTokenCountException ? PriamValidationException.ErrorType.FORMAT_FICHIER : PriamValidationException.ErrorType.FORMAT_ATTRIBUT;
