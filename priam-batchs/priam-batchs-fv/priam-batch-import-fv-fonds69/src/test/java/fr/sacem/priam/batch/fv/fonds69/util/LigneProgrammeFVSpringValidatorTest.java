package fr.sacem.priam.batch.fv.fonds69.util;
...
import fr.sacem.priam.batch.fv.fonds69.dao.SareftrTyputilDaoTest;
...
public class LigneProgrammeFVSpringValidatorTest extends CommonValidator implements Validator {
    ...
    @Autowired
    public SareftrTyputilDaoTest sareftrTyputilDao;
