package fr.sacem.priam.batch.fv.adclesprotection.rep.reader;
 ...
 * @since 1.0
 */
public class AdclesProtectionRepFlatItemReader extends AbstractItemCountingItemStreamItemReader<OctavDTO> implements
    ResourceAwareItemReaderItemStream<OctavDTO>, InitializingBean {

    private static final Log logger = LogFactory.getLog(AdclesProtectionRepFlatItemReader.class);
    ...
    private LineMapper<OctavDTO> lineMapper;
    ...
    public AdclesProtectionRepFlatItemReader() {
        setName(ClassUtils.getShortName(OctavDTO.class));
    }
    ...
    @Override
    protected OctavDTO doRead() throws Exception {
        if (noInput) {
            return null;
        }
