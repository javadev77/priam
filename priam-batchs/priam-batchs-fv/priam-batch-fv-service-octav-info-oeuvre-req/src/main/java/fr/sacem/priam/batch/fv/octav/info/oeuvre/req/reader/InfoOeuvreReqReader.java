package fr.sacem.priam.batch.fv.octav.info.oeuvre.req.reader;
...
@Component
@StepScope
public class InfoOeuvreReqReader extends JdbcPagingItemReader<LigneProgrammeFV> {

    private static final Logger LOGGER = LoggerFactory.getLogger(InfoOeuvreReqReader.class);

    public InfoOeuvreReqReader(@Value("#{jobParameters['idFichier']}") Long idFichier, @Autowired DataSource dataSource) {
