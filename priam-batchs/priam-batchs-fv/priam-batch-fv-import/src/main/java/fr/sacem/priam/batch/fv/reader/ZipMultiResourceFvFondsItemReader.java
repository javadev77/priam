 ...
 */
public class ZipMultiResourceFvFondsItemReader<T> extends MultiResourceItemReader<T> {

    private static final Logger LOG = LoggerFactory.getLogger(ZipMultiResourceFvFondsItemReader.class);
                        ...
                        if (archives[0] != null) {
                            ...
                            for (int j = 0; j < nbrDeFichierDansLeRepertoire; j++) {
                                ...
                                if (file.getName().matches(EXTENTION_ZIP)
                                        ...
                                        && FilenameUtils.removeExtension(file.getName()).matches(patternFileName)) {
                                    ...
                                    JobParameter jobParameterCategorieFonds = new JobParameter(file.getName().substring(17,24));
                                    ...
                                    if (renommageOk) {
                                        ...
                                        this.stepExecution.getExecutionContext().put("categorieFonds", jobParameterCategorieFonds);
                                    }
