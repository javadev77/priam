...
public class ReferentielParticipationFondsFileItemReader extends AbstractItemCountingItemStreamItemReader<ReferentielParticipationFonds> implements
        ResourceAwareItemReaderItemStream<ReferentielParticipationFonds>, InitializingBean {

    private static final Log logger = LogFactory.getLog(ReferentielParticipationFondsFileItemReader.class);
    ...
    private LineMapper<ReferentielParticipationFonds> lineMapper;
    ...
    public ReferentielParticipationFondsFileItemReader() {
        setName(ClassUtils.getShortName(ReferentielParticipationFondsFileItemReader.class));
    }
     ...
     */
    public void setLineMapper(LineMapper<ReferentielParticipationFonds> lineMapper) {
    ...
    @Override
    protected ReferentielParticipationFonds doRead() throws Exception {
        if (noInput) {
            return null;
        }
