package fr.sacem.priam.batch.fv.ad.info.req;
...
import fr.sacem.priam.batch.fv.ad.info.req.config.ConfigurationPriamLocal;
import fr.sacem.priam.batch.fv.ad.info.req.config.ConfigurationPriamProd;
...
public class App {
    ...
    public static void main(String[] args) {
        ...
        Job job = (Job) context.getBean("jobGenerationADInfoREQ");
