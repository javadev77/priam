 ...
 */
@Configuration
@ComponentScan(basePackages = {"fr.sacem.priam.batch.fv.octav.req", "fr.sacem.priam.batch.common.dao", "fr.sacem.priam.batch.common.fv", "fr.sacem.priam.batch.common.domain"})
@Profile({"dev","local"})
