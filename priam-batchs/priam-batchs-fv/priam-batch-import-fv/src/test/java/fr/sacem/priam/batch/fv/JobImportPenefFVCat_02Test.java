...
public class JobImportPenefFVCat_02Test {
    ...
    private String inputDirectory = "target/inputDirectoryCat_02/";
    ...
    private static final String CSV_FILE_NAME_12 = "FF_PENEF_EXTRANA_FONDS12_20181211161117.csv";
    private static final String CSV_FILE_PATH_12 = "src/test/resources/inputCsvCat_02/FF_PENEF_EXTRANA_FONDS12_20181211161117.csv";
    private static final String ZIP_FILE_PATH_12 = "target/inputDirectoryCat_02/FF_PENEF_EXTRANA_FONDS12_20181211161117.zip";
    ...
    public void setUp() {
        ...
        try {
            ...
            TestUtils.csvToZip(ZIP_FILE_PATH_12, CSV_FILE_PATH_12, CSV_FILE_NAME_12);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    @Test
    public void launchJobTestFV12()throws Exception{
        ...
        Fichier fichier = fichierDao.findByName(CSV_FILE_NAME_12);
