 ...
 */
@Component
public class LigneProgrammeFVSpringValidatorTest extends CommonValidator implements Validator {
    ...
    public static final String[] VAL1_CDEGREIDE12 = {"ME", "MS", "MO"};
    public static final String[] VAL2_CDEGREIDE12 = {"LP"};
    public static final String[] VAL3_CDEGREIDE12 = {"TOUS"};
    public static final String[] VAL4_CDEGREIDE12 = {"IJ"};
    ...
    public void validate(Object o, Errors errors) {
        ...
        if(("FD03".equals(cdeTypUtil) || "FD04".equals(cdeTypUtil) || "FD01".equals(cdeTypUtil) || "FD02".equals(cdeTypUtil))
            ...
            errors.rejectValue("cdeGreIde12", "format.error.cdeGreIde12");
        } else if("FD09".equals(cdeTypUtil) && !checkValeurCdeGreIde12ByCdeTypUtil(cdeGreIde12, VAL3_CDEGREIDE12)){
            errors.rejectValue("cdeGreIde12", "format.error.cdeGreIde12");
        }
    ...
    private void checkCdeTypUtilOri(SareftrTyputil sareftrTyputil, Map<String, List<String>> sareftrFamilTypUtilMap, Errors errors){
        ...
        if(sareftrTyputil != null){
            if(!checkCdeTypUtilOri(sareftrTyputil, sareftrFamilTypUtilMap)){
    ...
    private boolean checkValeurCdeGreIde12ByCdeTypUtil(String cdegreide12, String[] valeursCdegreide12){
        return Arrays.asList(valeursCdegreide12).contains(cdegreide12);
    }
}
