...
//        JobParameter parameter_categorie_fonds=(JobParameter) executionContext.get("categorieFonds");
...
//        String categorieFonds = (String)parameter_categorie_fonds.getValue();
