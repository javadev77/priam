...
import fr.sacem.priam.batch.fv.config.ConfigurationPriamLocal;
import fr.sacem.priam.batch.fv.config.ConfigurationPriamProd;
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            if(LOGGER.isDebugEnabled()) {
                LOGGER.info(String.format("inputDirectory : %1$s", admap.getInputFile()));
                LOGGER.info(String.format("outputDirectory : %1$s", admap.getOutputFile()));
            }
