 ...
 */
public class CsvPriamFileItemReader extends AbstractItemCountingItemStreamItemReader<Repartition> implements
        ResourceAwareItemReaderItemStream<Repartition>, InitializingBean {
    ...
    private LineMapper<Repartition> lineMapper;
     ...
     */
    public void setLineMapper(LineMapper<Repartition> lineMapper) {
     ...
     */
    @Override
    protected Repartition doRead() throws Exception {
        if (noInput) {
            return null;
        }
