...
public class CsvMultiResourceItemReader<T> extends MultiResourceItemReader<T> {
    ...
    public void open(ExecutionContext executionContext) throws ItemStreamException {
        inputDirectory = String.valueOf(fr.sacem.priam.common.constants.EnvConstants.FELIX_ACQT_INPUT_DIR);
        outputDirectory = String.valueOf(fr.sacem.priam.common.constants.EnvConstants.FELIX_ACQT_ARCHIVES_DIR);
