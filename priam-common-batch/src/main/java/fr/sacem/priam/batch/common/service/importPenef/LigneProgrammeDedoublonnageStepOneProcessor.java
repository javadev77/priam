...
import fr.sacem.priam.batch.common.util.RionEnum;
import fr.sacem.priam.batch.common.util.valdiator.importPenef.LigneProgrammeCMSSpringValidator;
...
public class LigneProgrammeDedoublonnageStepOneProcessor implements ItemProcessor<LigneProgramme, LigneProgramme> {

    private static final Logger log = LoggerFactory.getLogger(LigneProgrammeDedoublonnageStepOneProcessor.class);
    ...
    @Autowired
    private LigneProgrammeCMSSpringValidator validator;
