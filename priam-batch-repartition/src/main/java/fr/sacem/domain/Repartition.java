...
public class Repartition {
    ...
    public LocalDate getDatcalc() {
        return datcalc;
    }

    public void setDatcalc(LocalDate datcalc) {
    ...
    public Repartition(String numeroProgramme, LocalDate datcalc, Long rion, String status) {
        this.numeroProgramme = numeroProgramme;
        this.datcalc = datcalc;
        this.rion = rion;
        this.status = status;
