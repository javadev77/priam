package fr.sacem.priam.batch.catcms.rdo.reader;
...
public class ZipMultiResourceCatcmsRDOItemReader <T> extends MultiResourceItemReader<T> {
    private static final Logger LOG = LoggerFactory.getLogger(ZipMultiResourceCatcmsRDOItemReader.class);
