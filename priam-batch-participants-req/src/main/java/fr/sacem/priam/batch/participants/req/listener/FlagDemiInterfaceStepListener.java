...
public class FlagDemiInterfaceStepListener extends StepListenerSupport {
    ...
    public ExitStatus afterStep(StepExecution stepExecution) {
        ...
        String flagFilename = "Flag_" + FilenameUtils.removeExtension(reqFileName);
        try(OutputStream out = new FileOutputStream(new File(admap.getOutputFile() + File.separator + flagFilename))){
