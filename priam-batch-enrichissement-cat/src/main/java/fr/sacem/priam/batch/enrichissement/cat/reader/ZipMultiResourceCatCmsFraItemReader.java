...
public class ZipMultiResourceCatCmsFraItemReader<T> extends MultiResourceItemReader<T> {
    ...
    public void open(ExecutionContext executionContext) throws ItemStreamException {
        ...
        String typeCMS = (String)typeCMSParam.getValue();
                        ...
                        if (archives[0] != null) {
                            ...
                            for (int j = 0; j < nbrDeFichierDansLeRepertoire; j++) {
                                ...
                                if (file.getName().matches(EXTENTION_ZIP) && nbrDeFichierZipATraiter < 1 &&
                                        ((file.getName().startsWith(FileUtils.PREFIX_PENEF_CATALOGUE_FR) && typeCMS.equals(FileUtils.CATALOGUE_TYPE_CMS_FR)) ||
                                                (file.getName().startsWith(FileUtils.PREFIX_PENEF_CATALOGUE_ANF) && typeCMS.equals(FileUtils.CATALOGUE_TYPE_CMS_ANF)))) {
