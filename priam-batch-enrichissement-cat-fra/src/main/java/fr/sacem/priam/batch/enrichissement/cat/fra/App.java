...
import fr.sacem.priam.batch.enrichissement.cat.fra.config.ConfigurationPriamLocal;
import fr.sacem.priam.batch.enrichissement.cat.fra.config.ConfigurationPriamProd;
...
public class App {
    ...
    public static void main(String[] args) {
        ...
        Job job = (Job) context.getBean("jobEnrichissementFRA");
