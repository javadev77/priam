...
public class CataloguePenefCsvReader extends AbstractItemCountingItemStreamItemReader<CataloguePenefFra> implements
        ResourceAwareItemReaderItemStream<CataloguePenefFra>, InitializingBean {

    private static final Log logger = LogFactory.getLog(CataloguePenefCsvReader.class);
    ...
    private LineMapper<CataloguePenefFra> lineMapper;
    ...
    public CataloguePenefCsvReader() {

        setName(ClassUtils.getShortName(CataloguePenefCsvReader.class));
    }
     ...
     */
    @Override
    protected CataloguePenefFra doRead() throws Exception {
        if (noInput) {
            return null;
        }
