...
CREATE OR REPLACE VIEW PRIAM_LIGNE_PROG_VIEW AS
  ...
  FROM PRIAM_LIGNE_PROGRAMME_CP  lpr1,PRIAM_FICHIER f
...
CREATE INDEX IDX_IDE12 ON priam_app.PRIAM_LIGNE_PROGRAMME_CP (ide12);

-- CREATE INDEX IDX_IDE12 ON priam_app.PRIAM_LIGNE_PROGRAMME (ide12);