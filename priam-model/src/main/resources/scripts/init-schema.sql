...
CREATE TABLE PRIAM_STATUT (
  ...
  CODE VARCHAR(255) PRIMARY KEY NOT NULL  DEFAULT 'EN_COURS' COMMENT 'Code Statut',
...
CREATE TABLE PRIAM_FAMILLE_TYPUTIL (
  ...
  CODE VARCHAR(255) PRIMARY KEY NOT NULL  COMMENT 'Code Famille',
  LIBELLE VARCHAR(255) COMMENT 'Libelle du code',
  DESCRIPTION VARCHAR(255) COMMENT 'Description'
...
CREATE TABLE PRIAM_TYPUTIL (
  ...
  CODE VARCHAR(255) PRIMARY KEY NOT NULL COMMENT 'Code Type Utilisation',
...
CREATE TABLE PRIAM_FICHIER (
  ...
  STATUT_CODE VARCHAR(255) COMMENT 'Statut du fichier',
