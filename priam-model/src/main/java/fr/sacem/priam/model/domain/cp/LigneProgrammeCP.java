 ...
 */
@Entity
@Table(name = "PRIAM_LIGNE_PROGRAMME_CP")
public class LigneProgrammeCP implements Serializable {
    ...
    private LigneProgrammeCP oeuvreManuel;
    ...
    public LigneProgrammeCP getOeuvreManuel() {
        return oeuvreManuel;
    }
    
    public void setOeuvreManuel(LigneProgrammeCP oeuvreManuel) {
    ...
    public boolean equals(Object o) {
        ...
        LigneProgrammeCP that = (LigneProgrammeCP) o;
