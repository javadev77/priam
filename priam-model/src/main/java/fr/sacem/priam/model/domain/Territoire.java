...
public class Territoire implements Serializable {
    ...
    public Territoire(String cdeLng, Integer cdePaysIso4N, String nomPaysAbr, String nomPays, Date dateCre, String userCre, Date dateMaj, String userMaj) {
        this.cdeLng = cdeLng;
