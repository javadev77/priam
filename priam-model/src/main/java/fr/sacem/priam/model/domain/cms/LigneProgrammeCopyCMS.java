 ...
 */
@Entity
@Table(name = "PRIAM_LIGNE_PROGRAMME_CMS_COPY")
public class LigneProgrammeCopyCMS implements Serializable {
    ...
    private LigneProgrammeCopyCMS oeuvreManuel;
    ...
    public LigneProgrammeCopyCMS getOeuvreManuel() {
        return oeuvreManuel;
    }
    
    public void setOeuvreManuel(LigneProgrammeCopyCMS oeuvreManuel) {
    ...
    public boolean equals(Object o) {
        ...
        LigneProgrammeCopyCMS that = (LigneProgrammeCopyCMS) o;
