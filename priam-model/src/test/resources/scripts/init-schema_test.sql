...
CREATE TABLE SAREFTJ_LIBFAMILTYPUTIL (
  ...
  CDEFAMILTYPUTIL VARCHAR(255) NOT NULL  COMMENT 'Code SareftrFamiltyputil',
  LIBABRGFAMILTYPUTIL VARCHAR(255) COMMENT 'Libelle du code',
  CDELNG VARCHAR(2) COMMENT 'Traduction',


  PRIMARY KEY(CDEFAMILTYPUTIL, CDELNG)

);

CREATE TABLE SAREFTJ_LIBTYPUTIL (

  CDETYPUTIL VARCHAR(255) NOT NULL COMMENT 'Code Type Utilisation',
  CDELNG VARCHAR(2) COMMENT 'tradution',
  LIBABRGTYPUTIL VARCHAR(255) COMMENT 'Libelle du code',

  PRIMARY KEY(CDETYPUTIL, CDELNG)
...
CREATE TABLE SAREFTR_TYPUTIL (
  ...
  CONSTRAINT SAREFR_TYPUTIL_PK PRIMARY KEY (CDETYPUTIL),
  CONSTRAINT PRIAM_TYPUT_TYPUTILFAMILL_FK FOREIGN KEY (CDEFAMILTYPUTIL) REFERENCES SAREFTR_FAMILTYPUTIL(CDEFAMILTYPUTIL)
);
...
CREATE TABLE PRIAM_FICHIER (
  ...
  SOURCE_AUTO INT(1) NOT NULL DEFAULT '1',
