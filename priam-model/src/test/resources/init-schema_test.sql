...
CREATE TABLE PRIAM_CATCMS_PARTICIPANTS (
  ...
  CONSTRAINT `FK_TYPE_CMS` FOREIGN KEY (TYPE_CMS) REFERENCES PRIAM_CATCMS_PARTICIPANTS(TYPE_CMS),
  CONSTRAINT `FK_IDE12` FOREIGN KEY (IDE12) REFERENCES PRIAM_CATCMS_PARTICIPANTS(IDE12)
