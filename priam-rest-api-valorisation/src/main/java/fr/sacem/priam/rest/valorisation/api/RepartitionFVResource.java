...
//    public ProgrammeDto generateFichierFelix(@RequestParam(value = "numProg") String numProg, @RequestParam(value = "modeRepartition") String modeRepartition, @RequestParam(value = "typeRepartFV") String typeRepartFV, UserDTO userDTO) throws IOException {
...
//        fichierFelixDao.flush();
//
//        launchJobRepartitionFV(numProg, modeRepartition, typeRepartFV, userDTO);
//
//        return new ProgrammeDto();
//    }
//
//    protected void launchJobRepartitionFV(String numProg, String modeRepartition, String typeRepartFV, UserDTO userDTO){
...
//            jobParametersMap.put("famille", new JobParameter(FamillePriam.VALORISATION.getCode()));
